...
def efecto_visual_cuadro(visitados, en_proceso):
    ...
    while efecto_activo:
        # Limpia la terminal
        print("\033c" if os.name != 'nt' else "\x1B[2J\x1B[H", end="")
        ...
        ancho_cuadro = int(ancho_terminal * 0.8)
        alto_cuadro = int(alto_terminal * 0.8)
        ...
        titulo = pyfiglet.figlet_format("BunkerWallx", font='block')
        print(f"\033[96m{titulo}\033[0m")  # Color cyan
        ...
        time.sleep(0.015)  # Ajustar la velocidad del efecto        
